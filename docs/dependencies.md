...
| sha2 | SHA-256 revision content identity | default | MIT/Apache-2.0 | Pure Rust selected path; transitive review | AWS-LC digest, blake3 | Pin 0.10 lockfile; known-answer and tamper tests |
