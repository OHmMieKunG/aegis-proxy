...
- Access events currently use the process tracing subscriber. Bounded asynchronous exporters, rotation guidance, Prometheus metrics, and OpenTelemetry delivery belong to Phase 9.
...
- Native route OIDC, arbitrary middleware ordering, runtime plugins, cache/store plugins, and a general buffering middleware are not Phase 7 scope.
